...
const Controls = ({ isPlaying, heart, handleSetHeart, repeat, setRepeat, shuffle, setShuffle, currentSongs, handlePlayPause, handlePrevSong, handleNextSong }) => (
    <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
        ...
        <FaHeart size={20} color={heart ? 'red' : 'white'} onClick={handleSetHeart} className="hidden sm:block cursor-pointer" />
